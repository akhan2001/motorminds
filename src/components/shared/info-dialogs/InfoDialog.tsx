...
export const InfoDialog: React.FC<InfoDialogProps> = ({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col bg-white dark:bg-[#131313] border-border dark:border-[#333333] p-0">
                <DialogHeader className="sticky top-0 z-10 bg-white dark:bg-[#131313] border-b border-border dark:border-[#333333] px-6 pt-6 pb-4">
