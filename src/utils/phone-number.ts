...
export async function findCustomerByPhone(
  ...
  console.log('🔍 Searching for customer with phone variations:', phoneVariations.variations);
...
export async function createOrFindCustomerByPhone(
  ...
  console.log('🆕 Creating new customer with phone:', defaultPhone);
...
export async function findConversationsByPhone(
  ...
  console.log('🔍 Searching for conversations with phone variations:', phoneVariations.variations);
  ...
  console.log(`✅ Found ${conversations?.length || 0} conversations for phone:`, phoneNumber);
...
export async function mergeDuplicateConversations(
  ...
  console.log(`🔄 Merging ${conversations.length} conversations for phone:`, phoneNumber);
  ...
  for (const conv of deleteConversations) {
    await supabase
      ...
      .delete()
      .eq('id', conv.id);
    console.log('🗑️ Deleted duplicate conversation:', conv.id);
  }
