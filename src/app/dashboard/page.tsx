...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      const messagesData = await getMessages("850e8400-e29b-41d4-a716-446655440001")
      if (messagesData) {
          ...
          <div className="lg:col-span-1">
            <Card className="bg-gray-900 border-gray-800 text-white h-full">
              ...
              <CardContent className="p-6 flex flex-col h-full overflow-y-auto max-h-[600px]">
                      ...
                      <Card key={msg.id} className="bg-gray-800 border-gray-700">
                        ...
                        <CardContent className="py-2">
                          ...
                          <div className="flex flex-col text-xs text-gray-400 mt-2">
                            ...
                            {msg.phone_number && (
                              <span>Phone: {msg.phone_number}</span>
                            )}
                            <span className="mt-1">
                ...
                <Button
                  onClick={() =>
                    getMessages("850e8400-e29b-41d4-a716-446655440001")
                  }
                  className="mt-4"
                >
                  Refresh Messages
