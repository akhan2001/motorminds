...
export async function POST(
    ...
    try {
        ...
        // Search by display_id (human-readable like INV-209)
        ...
        // Create invoice view URL - use display_id for the URL
        const invoiceUrl = `${config.app.baseUrl}/invoices?invoiceId=${displayId}`
        ...
        console.error('Error sending customer invoice by display ID:', error)
