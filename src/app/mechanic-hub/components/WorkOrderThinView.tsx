...
export function WorkOrderThinView({ order, statusColors, priorityColors, onClick }: WorkOrderThinViewProps) {
  ...
  return (
    <div 
      className="bg-[#222222] rounded-lg overflow-hidden border border-[#333333] hover:border-[#444444] transition-all duration-200 hover:bg-[#252525]"
    >
      <div className="p-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="text-[#9d9d9d] hover:text-white hover:bg-zinc-800"
            onClick={onClick}
          >
            View
          </Button>
