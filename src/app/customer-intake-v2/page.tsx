...
import CustomerIntakeFormV2 from '../customer-intake/components/customer-intake-form-v2'
import Image from 'next/image'

export default function CustomerIntakeV2Page() {
        ...
        <div className="flex flex-col min-h-screen bg-black text-white">
            ...
            <main className="flex-1 container mx-auto py-6 px-4">
                <div className="text-center mb-8">
                    <h1 className="text-2xl font-bold mb-2">Customer Information Form</h1>
                    <p className="text-gray-400">Please fill out your details below</p>
                </div>
                <CustomerIntakeFormV2 shopId={shopId} user={user} />
            </main>
