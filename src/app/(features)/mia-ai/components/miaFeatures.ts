...
export const miaFeatures = [
    ...
    // },
    {
        ...
        href: "/mia",
        badge: "Diagnostics",
        features: ["Symptom Analysis", "Issue Detection", "Repair Suggestions"]
    },
    {
        title: "Mia Parts",
        description: "Intelligent parts sourcing and ordering with AI recommendations.",
        icon: Package,
        color: "bg-purple-500",
        hoverColor: "hover:bg-purple-600",
        href: "/parts-ordering",
        badge: "Parts",
        features: ["Smart Sourcing", "Price Comparison", "Ordering System"]
    }
    // {
    //     title: "Mia Calling",
