...
interface PartsIntakeModalProps {
    open: boolean
...
export default function PartsIntakeModal({ 
    open, 
    onOpenChange, 
    supplierId, 
    onSuccess 
}: PartsIntakeModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-[#0d0d0d] border-[#2a2a2a]">
                <DialogHeader>
                    <DialogTitle className="text-white">Request Parts from Supplier</DialogTitle>
                </DialogHeader>
                <div className="mt-4">
                    <PartsIntakeForm
