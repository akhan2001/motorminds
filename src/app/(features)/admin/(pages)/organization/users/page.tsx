...
export default function OrganizationUsersPage() {
    ...
    const getRoleColor = (role: string) => {
        switch (role) {
            case 'admin': return 'bg-purple-100 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 border-purple-300 dark:border-purple-700'
                        ...
                        <div className="flex justify-between items-center mb-6">
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Manage users across all shops in your organization
                                </p>
                            </div>
                            <div className="flex gap-3">
                                <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white">
                                    <Link href="/admin/organization/create-user">
                                        Create User
                                    </Link>
                                </Button>
                                <Button
