...
export default function OrganizationCreateUserPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!userLimit?.canCreate) {
            toast.error(`You have reached the maximum limit of ${userLimit?.limit} users.`)
            return
        }
                    ...
                    <div className="p-6 max-w-4xl mx-auto w-full">
                        ...
                        <Breadcrumb className="mb-4">
                            <BreadcrumbList>
                                ...
                                <BreadcrumbItem>
                                    <BreadcrumbLink asChild>
                                        <Link href="/admin/organization/users" className="text-muted-foreground hover:text-foreground">
                                            Users
                                        </Link>
                                    </BreadcrumbLink>
                                </BreadcrumbItem>
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Add a new user to your organization (Max 3 users)
                                </p>
                            </div>
                        </div>
                            ...
                            <CardContent>
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor="shop_id" className="text-foreground">
                                                Shop (Optional)
                                            </Label>
                                            <Select
                                    ...
                                    {!userLimit?.canCreate && (
                                        <div className="flex items-start gap-2 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                                            ...
                                            <div className="text-sm text-red-700 dark:text-red-300">
                                                ...
                                                <p>
                                                    You have reached the maximum limit of {userLimit?.limit} users. 
                                    ...
                                    <div className="flex gap-3 pt-4">
                                        ...
                                        <Button asChild variant="outline" type="button">
                                            <Link href="/admin/organization/users">Cancel</Link>
                                        </Button>
                                    </div>
                                </form>
                            </CardContent>
