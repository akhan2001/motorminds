...
import { Building2, Users, TrendingUp, Package, Settings, BarChart3, User } from 'lucide-react'
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <Card className="hover:shadow-md transition-shadow">
                                <CardContent className="p-6">
                                    ...
                                    <h3 className="text-lg font-semibold text-foreground mb-2">Organization Customers</h3>
                                    <p className="text-sm text-muted-foreground mb-4">
                                        Look through all MSO customers
                                    </p>
                                    <Button asChild className="w-full bg-gray-600 hover:bg-gray-700 text-white">
                                        <Link href="/admin/organization/customers">
                                            Customers
                                        </Link>
                                    </Button>
                                </CardContent>
