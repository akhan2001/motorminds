...
export const WorkOrderAnalysis: React.FC<WorkOrderAnalysisProps> = ({ analysis }) => {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="bg-[#131313] border border-[#2a2a2a] rounded-lg p-4 space-y-4">
                {/* Current Work Assessment */}
                <div>
                    <div className="flex items-center space-x-2 mb-2">
                        <Wrench className="h-4 w-4 text-blue-400" />
                        <h5 className="text-sm font-medium text-gray-300">Current Work Assessment</h5>
                    </div>
                ...
                {analysis.related_systems && analysis.related_systems.length > 0 && (
                    <div>
                        <div className="flex items-center space-x-2 mb-2">
                            ...
                            <h5 className="text-sm font-medium text-gray-300">Related Systems</h5>
                        </div>
                        <div className="flex flex-wrap gap-2">
                            {analysis.related_systems.map((system, index) => (
                                <span 
                                    key={index}
                                    className="px-2 py-1 bg-blue-900/20 border border-blue-500/30 rounded text-xs text-blue-300"
                                >
                                    {system}
                                </span>
                            ))}
                ...
                {analysis.mileage_considerations && (
                    <div>
                        <div className="flex items-center space-x-2 mb-2">
                            ...
                            <h5 className="text-sm font-medium text-gray-300">Mileage Considerations</h5>
                        </div>
                        <p className="text-sm text-gray-400 leading-relaxed">
                            {analysis.mileage_considerations}
                        </p>
                ...
                {analysis.timing_recommendations && (
                    <div>
                        <div className="flex items-center space-x-2 mb-2">
                            ...
                            <h5 className="text-sm font-medium text-gray-300">Timing Recommendations</h5>
                        </div>
                        <p className="text-sm text-gray-400 leading-relaxed">
                            {analysis.timing_recommendations}
                        </p>
