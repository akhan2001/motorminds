		...
		<div className="space-y-4">
			...
			<div className="flex flex-col gap-y-4 my-4 max-w-xl">
				<p className="text-sm text-muted-foreground">
					MotorMinds AI can provide more relevant answers if you
					choose to share different levels of data. This feature is
					powered by third-party AI providers. This is a shop-wide
					setting, so please select the level of data you are
					comfortable sharing.
				</p>
				<OptInToAIToggle />
			</div>
