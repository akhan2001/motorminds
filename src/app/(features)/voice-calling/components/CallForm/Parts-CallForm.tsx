        ...
        <Card className="bg-card dark:bg-[#111111] border-border dark:border-[#2a2a2a]">
            ...
            <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <Label className="text-foreground dark:text-white">Part Name</Label>
                        <Input
                    ...
                    <div>
                        <Label className="text-foreground dark:text-white">Part Number</Label>
                        <Input
                    ...
                    <div>
                        <Label className="text-foreground dark:text-white">Quantity</Label>
                        <Input
                            type="number"
