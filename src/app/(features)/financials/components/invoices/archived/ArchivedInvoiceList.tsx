...
import { AlertCircle, Archive, FileText } from 'lucide-react'
...
interface ArchivedInvoiceListProps {
    searchValue: string
...
const ArchivedInvoiceList: React.FC<ArchivedInvoiceListProps> = ({
    searchValue,
    onInvoiceClick,
    selectedInvoiceId
}) => {
    ...
    // Filter invoices based on search (client-side for additional filtering)
...
export default ArchivedInvoiceList
