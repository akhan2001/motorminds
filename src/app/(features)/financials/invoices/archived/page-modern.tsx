...
import { ModernArchivedInvoicesList } from "./components/ModernArchivedInvoicesList"
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <div className="flex-1 overflow-y-auto">
                    <div className="p-6 max-w-7xl mx-auto w-full">
                        ...
                        {/* Modern Invoice List with URL State Management */}
                        <SearchProvider>
                            <ModernArchivedInvoicesList />
                        </SearchProvider>
                    </div>
                </div>
            </div>
...
export default function ModernArchivedInvoicesPage() {
    return (
