...
export default function PayrollClient() {
  ...
  const {
    ...
    modalData: employeeToDeactivate,
    openModal: handleOpenDeactivateConfirm,
    closeModal: handleCloseDeactivateConfirm,
  } = useModalState<any>();
    ...
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <main className="flex-1 p-8 max-w-7xl mx-auto w-full">
        ...
        <EmployeeCostTable 
            ...
            onDeactivate={handleOpenDeactivateConfirm}
        />
      </main>
        ...
        <ConfirmationDialog
            ...
            onConfirm={() => {
                if (employeeToDeactivate) handleDeactivate(employeeToDeactivate.id)
            }}
            title={`Deactivate ${employeeToDeactivate?.full_name}`}
            description="Are you sure you want to deactivate this employee? This action is reversible from the employee settings."
