            ...
            <div className="flex items-center justify-center py-8">
				<div className="container mx-auto max-w-[1300px]">
					<div className="flex flex-col">
						<h1 className="text-3xl font-bold mb-2 flex items-center gap-2 text-white">Lead Generator</h1>
						<p className="text-gray-400">
						Manage your leads and track their activity. Add new leads, edit their information, and view their activity.
					</p>
					</div>
