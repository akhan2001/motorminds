...
export default function ChatStart() {
    return (
        <div className="flex flex-col gap-10 text-center py-8 px-5 bg-[#0D0D0D] rounded-[20px]">
            <div className="">
            ...
            <div className="flex flex-row gap-5">
                <button className="w-[33%] bg-[#222222] rounded-[10px] hover:bg-[#222222]/70 transition duration-300 ease-in-out">
