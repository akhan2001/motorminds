...
drop policy if exists "Allow select for own shop" on public.fixed_costs;
...
drop policy if exists "Allow insert for own shop" on public.fixed_costs;
...
drop policy if exists "Allow update for own shop" on public.fixed_costs;
...
drop policy if exists "Allow delete for own shop" on public.fixed_costs;
